...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/_3.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=source/app_heartbeat.S source/config_bits.S source/data.S source/hardware.S source/main.S source/lcd.S source/app_clock.c source/keypad.S source/svc_keypad.c source/app_test_keypad.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/source/app_heartbeat.o ${OBJECTDIR}/source/config_bits.o ${OBJECTDIR}/source/data.o ${OBJECTDIR}/source/hardware.o ${OBJECTDIR}/source/main.o ${OBJECTDIR}/source/lcd.o ${OBJECTDIR}/source/app_clock.o ${OBJECTDIR}/source/keypad.o ${OBJECTDIR}/source/svc_keypad.o ${OBJECTDIR}/source/app_test_keypad.o
POSSIBLE_DEPFILES=${OBJECTDIR}/source/app_heartbeat.o.d ${OBJECTDIR}/source/config_bits.o.d ${OBJECTDIR}/source/data.o.d ${OBJECTDIR}/source/hardware.o.d ${OBJECTDIR}/source/main.o.d ${OBJECTDIR}/source/lcd.o.d ${OBJECTDIR}/source/app_clock.o.d ${OBJECTDIR}/source/keypad.o.d ${OBJECTDIR}/source/svc_keypad.o.d ${OBJECTDIR}/source/app_test_keypad.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/source/app_heartbeat.o ${OBJECTDIR}/source/config_bits.o ${OBJECTDIR}/source/data.o ${OBJECTDIR}/source/hardware.o ${OBJECTDIR}/source/main.o ${OBJECTDIR}/source/lcd.o ${OBJECTDIR}/source/app_clock.o ${OBJECTDIR}/source/keypad.o ${OBJECTDIR}/source/svc_keypad.o ${OBJECTDIR}/source/app_test_keypad.o

# Source Files
SOURCEFILES=source/app_heartbeat.S source/config_bits.S source/data.S source/hardware.S source/main.S source/lcd.S source/app_clock.c source/keypad.S source/svc_keypad.c source/app_test_keypad.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/_3.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/source/keypad.o: source/keypad.S  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/source/keypad.o 
	@${RM} ${OBJECTDIR}/source/keypad.o.ok ${OBJECTDIR}/source/keypad.o.err 
	${MP_CC} $(MP_EXTRA_AS_PRE)  -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/source/keypad.o.d"  -o ${OBJECTDIR}/source/keypad.o source/keypad.S  -DXPRJ_default=$(CND_CONF)  -legacy-libc  -Wa,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_AS_POST),-MD="${OBJECTDIR}/source/keypad.o.asm.d",--gdwarf-2 -mdfp="${DFP_DIR}"
	@${FIXDEPS} "${OBJECTDIR}/source/keypad.o.d" "${OBJECTDIR}/source/keypad.o.asm.d" -t $(SILENT) -rsi ${MP_CC_DIR}../ 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/_3.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk  library/lab1_libs.X.a  
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -g -mdebugger -D__MPLAB_DEBUGGER_ICD4=1 -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/_3.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}    library\lab1_libs.X.a      -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)   -mreserve=data@0x0:0x1FC -mreserve=boot@0x1FC02000:0x1FC02FEF -mreserve=boot@0x1FC02000:0x1FC024FF  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,-D=__DEBUG_D,--defsym=__MPLAB_DEBUGGER_ICD4=1,--no-code-in-dinit,--no-dinit-in-serial-mem,-L"library",-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -mdfp="${DFP_DIR}"
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/_3.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk  library/lab1_libs.X.a 
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/_3.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}    library\lab1_libs.X.a      -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--no-code-in-dinit,--no-dinit-in-serial-mem,-L"library",-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -mdfp="${DFP_DIR}"
	${MP_CC_DIR}\\xc32-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/_3.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} 
endif
